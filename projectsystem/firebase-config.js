 ...
 *
 * This file contains the Firebase project configuration for the C4S Food Solution
 * Payroll System. It provides the connection settings for Firebase services
 * including Authentication, Firestore, and Realtime Database.
 *
 * IMPORTANT: Keep your Firebase API keys secure. While client-side API keys
 * are designed to be public, you should configure Firebase Security Rules
 ...
 *   4. Copy the Firebase SDK snippet config values
 */
